...
class RawDataValidation:
    ...
    def values_from_schema(self,):
        ...
        Output(s) : returns
            ...
            column_names: a python dictionary of keys as column names and values as corresponding datatype.   
    ...
    def create_directory_for_good_bad_raw_data(self):
        ...
        and Bad_Data after validation the training data.  
        Input(s) : None  
        Output(s) : None  
        ...
        try:
            ...
            Exited 'create_directory_for_good_bad_raw_data' method of 'RawDataValidation' class."""
            self.logger.log(log_file, msg)
            log_file.close()
            ...
            error_log_msg = f"""Exited 'create_directory_for_good_bad_raw_data' method of 'RawDataValidation' class."""
            self.logger.log(log_file, error_log_msg)
            ...
            log_file = open("Training_Logs/General_Log.txt", "a+")
            error_log_msg = f"""Exception occured  at 'create_directory_for_good_bad_raw_data' method of 'RawDataValidation' class.
            Exception message : {str(e)}"""
            self.logger.log(log_file, error_log_msg)
    ...
    def delete_exising_good_data_training_folder(self):
        ...
        try:
            log_file = open("Training_Logs/General_Log.txt", "a+")
            log_msg = f"""Entered 'delete_exising_good_data_training_folder' method of 'RawDataValidation' class."""
            ...
            error_log_msg = f"""Exited 'delete_exising_good_data_training_folder' method of 'RawDataValidation' class."""
            self.logger.log(log_file, error_log_msg)
    ...
    def delete_exising_bad_data_training_folder(self):
        ...
        try:
            log_file = open("Training_Logs/General_Log.txt", "a+")
            log_msg = f"""Entered 'delete_exising_bad_data_training_folder' method of 'RawDataValidation' class."""
            self.logger.log(log_file, log_msg)
            ...
            error_log_msg = f"""Exited 'delete_exising_bad_data_training_folder' method of 'RawDataValidation' class."""
            self.logger.log(log_file, error_log_msg)
    ...
    def move_bad_files_to_archive_bad(self):
        ...
        try:
            log_file_path = os.path.join("Training_Logs", "General_Log.txt")
            log_file = open(log_file_path, "a+")
            log_msg = f"""Entered 'move_bad_files_to_archive_bad' method of 'RawDataValidation' class."""
            self.logger.log(log_file, log_msg)
            ...
            error_log_msg = f"""Exited 'move_bad_files_to_archive_bad' method of 'RawDataValidation' class."""
            self.logger.log(log_file, error_log_msg)
    ...
    def raw_file_name_validation(self,
        ...
        try:
            with open("Training_Logs/nameValidationLog.txt", "a+") as log_file:
                log_msg = f"""Entered 'raw_file_name_validation' method of 'RawDataValidation' class."""
                self.logger.log(log_file, log_msg)
                    ...
                    if(regex.match(regex_pattern, file)):
                        ...
                        if (len(split_at_dot[1]) == len_of_date_stamp_in_file):
                            if (len(split_at_dot[2]) == len_of_time_stamp_in_file):
                                shutil.copy("Training_Batch_Files/" + file,
            ...
            with open("Training_Logs/nameValidationLog.txt", "a+") as log_file:
                ...
                error_log_msg = f"""Exiting from 'raw_file_name_validation' method of 'RawDataValidation' class."""
                self.logger.log(log_file, log_msg)
            raise Exception
    ...
    def validate_column_lenth(self, no_of_columns):
        ...
        try:
            with open("Training_Logs/columnValidationLog.txt", "a+") as log_file:
                log_msg = f"""Column length validation started!"""
                self.logger.log(log_file, log_msg)

                all_items = os.listdir("Training_Raw_Files_Validated/Good_Raw/")  # all items in the directory
                only_files = [item for item in all_items if os.path.isfile(os.path.join("Training_Raw_Files_Validated/Good_Raw", item)) and item != ".DS_Store"]
            ...
            with open("Training_Logs/columnValidationLog.txt", "a+") as log_file:
                ...
                error_log_msg = f"""Exiting 'validate_column_lenth' method of 'RawDataValidation' class."""
                self.logger.log(log_file, error_log_msg)
    ...
    def validate_missing_values_in_whole_column(self,):
        ...
        try:
            with open("Training_Logs/missingValuesInColumn.txt", "a+") as log_file:
                log_msg = f"""Entered 'validate_missing_values_in_whole_column' method in 'RawDataValidation' class."""
                self.logger.log(log_file, log_msg)
                ...
                for file in only_files:
                    df = pd.read_csv(os.path.join("Training_Raw_Files_Validated/Good_Raw", file))
                    ...
                    if df.columns[0] == 'Unnamed: 0':  # if the first column name is missing, change the column name into 'wafer'
                        ...
                        df.to_csv(os.path.join("Training_Raw_Files_Validated/Good_Raw", file),
                                  index=False,)
                    ...
                    if len(all_nan_columns_list) > 0:
                        source_path = os.path.join("Training_Raw_Files_Validated/Good_Raw", file)
                        destination_path = os.path.join("Training_Raw_Files_Validated", "Bad_Raw")
            ...
            with open("Training_Logs/missingValuesInColumn.txt", "a+") as log_file:
                ...
                error_log_msg = f"""Exiting 'validate_missing_values_in_whole_column' method of 'RawDataValidation' class."""
                self.logger.log(log_file, error_log_msg)
